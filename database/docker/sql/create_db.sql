...
(
    `electronic_place_id` VARCHAR(45)   NOT NULL,
    `name`                VARCHAR(1000) NOT NULL,
...
(
    ...
    `delivery_place_indication`       VARCHAR(20)   NOT NULL,
    ...
    `electronic_place_id`             VARCHAR(45)   NULL,
...
-- -----------------------------------------------------
-- Table `zakupki`.`purchase_notice_documentation_delivary`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zakupki`.`purchase_notice_documentation_delivary`
(
    `purchase_notice_data_guid` VARCHAR(36)   NOT NULL,
...
-- -----------------------------------------------------
-- Table `zakupki`.`documentation_delivary_payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zakupki`.`documentation_delivary_payment`
(
    `purchase_notice_data_guid` VARCHAR(36)    NOT NULL,
    `currency_code`             VARCHAR(3)     NOT NULL,
    `sum`                       DECIMAL(22, 2) NOT NULL,
    `procedure`                 VARCHAR(2000)  NOT NULL,
    INDEX `fk_documentation_delivary_payment_purchase_notice_documenta_idx` (`purchase_notice_data_guid` ASC) VISIBLE,
    PRIMARY KEY (`purchase_notice_data_guid`),
    INDEX `fk_documentation_delivary_payment_currency1_idx` (`currency_code` ASC) VISIBLE,
    CONSTRAINT `fk_documentation_delivary_payment_purchase_notice_documentati1`
        FOREIGN KEY (`purchase_notice_data_guid`)
            REFERENCES `zakupki`.`purchase_notice_documentation_delivary` (`purchase_notice_data_guid`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `fk_documentation_delivary_payment_currency1`
        FOREIGN KEY (`currency_code`)
            REFERENCES `zakupki`.`currency` (`code`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
...
(
    ...
    `delivary_place_indication_code` VARCHAR(3)  NOT NULL,
    `joint_lot`                      TINYINT(1)  NULL,
    `plan_guid`                      VARCHAR(36) NULL,
    `position_number`                VARCHAR(36) NULL,
    `lot_plan_position`              VARCHAR(36) NULL,
    `position_guid`                  VARCHAR(36) NULL,
    `purchase_notice_lotcol`         VARCHAR(45) NULL,
...
(
    ...
    `exchange_rate`                    DECIMAL(16, 6) NULL,
    `exchange_rate_date`               DATE           NULL,
    `initial_sum`                      DECIMAL(22, 2) NOT NULL,
...
(
    ...
    `delivery_address`                                          TEXT(2000)     NULL,
    `commodity_item_price`                                      DECIMAL(22, 2) NULL,
    `delivary_region_okato`                                     DECIMAL(22, 2) NULL,
...
(
    ...
    INDEX `fk_non_resident_info_lot_customer_data1_idx` (`lot_customer_data_joint_lot_data_purchase_notice_lot_guid`
                                                         ASC, `lot_customer_data_joint_lot_data_customer_inn`
                                                         ASC) VISIBLE,
    PRIMARY KEY (`lot_customer_data_joint_lot_data_purchase_notice_lot_guid`,
                 `lot_customer_data_joint_lot_data_customer_inn`),
    INDEX `fk_non_resident_info_country1_idx` (`country_code` ASC) VISIBLE,
    CONSTRAINT `fk_non_resident_info_lot_customer_data1`
        FOREIGN KEY (`lot_customer_data_joint_lot_data_purchase_notice_lot_guid`,
                     `lot_customer_data_joint_lot_data_customer_inn`)
            REFERENCES `zakupki`.`lot_customer_data` (`joint_lot_data_purchase_notice_lot_guid`,
                                                      `joint_lot_data_customer_inn`)
