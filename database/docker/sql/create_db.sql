...
-- -----------------------------------------------------
-- Table `zakupki`.`purchase_contract_supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zakupki`.`purchase_contract_supplier`
(
    `guid`    VARCHAR(36) NOT NULL,
    `inn`     VARCHAR(12) NULL,
    `name`    TEXT        NULL,
...
(
    ...
    CONSTRAINT `fk_purchase_contract_purchase_contract_supplier1`
        FOREIGN KEY (`supplier_guid`)
            REFERENCES `zakupki`.`purchase_contract_supplier` (`guid`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
)
    ENGINE = InnoDB;
