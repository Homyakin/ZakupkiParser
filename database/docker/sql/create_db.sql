...
(
    ...
    `purchase_method_name`   TEXT        NULL,
    `emergency`              TINYINT(1)  NULL,
    PRIMARY KEY (`guid`),
...
(
    ...
    `protocol_lot_guid`          VARCHAR(36) NOT NULL,
    `protocol_lot_criteria_guid` VARCHAR(36) NULL,
    PRIMARY KEY (`id`, `purchase_protocol_guid`),
    INDEX `fk_protocol_lot_applications_protocol_lot1_idx` (`protocol_lot_guid` ASC) VISIBLE,
    INDEX `fk_protocol_lot_applications_protocol_lot_criteria1_idx` (`protocol_lot_criteria_guid` ASC) VISIBLE,
    ...
    CONSTRAINT `fk_protocol_lot_applications_protocol_lot1`
        FOREIGN KEY (`protocol_lot_guid`)
            ...
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `fk_protocol_lot_applications_protocol_lot_criteria1`
...
(
    ...
    INDEX `fk_application_protocol_lot_criteria1_idx` (`criteria_guid` ASC) VISIBLE,
    ...
    CONSTRAINT `fk_application_application_rejection_reason1`
        FOREIGN KEY (`application_rejection_reason_code`)
            ...
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `fk_application_protocol_lot_criteria1`
        FOREIGN KEY (`criteria_guid`)
            REFERENCES `zakupki`.`protocol_lot_criteria` (`guid`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
)
...
(
    `application_application_number`    VARCHAR(30) NOT NULL,
    `accepted`                          VARCHAR(45) NOT NULL,
    `application_rejection_reason_code` VARCHAR(30) NULL,
    `rejection_reason`                  TEXT        NULL,
    PRIMARY KEY (`application_application_number`),
    INDEX `fk_application_qualyfing_competition_application_rejection__idx` (`application_rejection_reason_code` ASC) VISIBLE,
    CONSTRAINT `fk_application_qualyfing_competition_application1`
        FOREIGN KEY (`application_application_number`)
            REFERENCES `zakupki`.`application` (`number`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `fk_application_qualyfing_competition_application_rejection_re1`
        FOREIGN KEY (`application_rejection_reason_code`)
            REFERENCES `zakupki`.`application_rejection_reason` (`code`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
...
(
    ...
    PRIMARY KEY (`application_application_number`),
    INDEX `fk_application_qualyfing_competition_application_rejection__idx` (`application_rejection_reason_code` ASC) VISIBLE,
    CONSTRAINT `fk_application_qualyfing_competition_application10`
        FOREIGN KEY (`application_application_number`)
            REFERENCES `zakupki`.`application` (`number`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `fk_application_qualyfing_competition_application_rejection_re10`
        FOREIGN KEY (`application_rejection_reason_code`)
            REFERENCES `zakupki`.`application_rejection_reason` (`code`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
...
-- -----------------------------------------------------
-- Table `zakupki`.`application_to_lot`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zakupki`.`application_to_lot`
(
    `protocol_lot_applications_id` INT         NOT NULL,
    `purchase_protocol_guid`       VARCHAR(36) NOT NULL,
    `application_number`           VARCHAR(30) NOT NULL,
    PRIMARY KEY (`protocol_lot_applications_id`, `purchase_protocol_guid`, `application_number`),
    INDEX `fk_application_to_lot_application1_idx` (`application_number` ASC) VISIBLE,
    CONSTRAINT `fk_application_to_lot_protocol_lot_applications1`
        FOREIGN KEY (`protocol_lot_applications_id`, `purchase_protocol_guid`)
            REFERENCES `zakupki`.`protocol_lot_applications` (`id`, `purchase_protocol_guid`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `fk_application_to_lot_application1`
