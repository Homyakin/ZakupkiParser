...
(
    ...
    INDEX `fk_supplier_to_contract_supplier1_idx` (`supplier_id` ASC) VISIBLE,
    PRIMARY KEY (`contract_guid`, `supplier_id`),
    ...
    CONSTRAINT `fk_supplier_to_contract_supplier1`
        FOREIGN KEY (`supplier_id`)
            REFERENCES `zakupki`.`supplier` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
)
    ENGINE = InnoDB;
