...
(
    ...
    `notice_44_num`                                    VARCHAR(200)   NULL,
    ...
    `plan_position_guid`                               VARCHAR(36)    NOT NULL,
    ...
    `purchase_notice_info_guid`                        VARCHAR(36)    NOT NULL,
    `purchase_notice_info_number`                      VARCHAR(11)    NOT NULL,
...
(
    ...
    PRIMARY KEY (`contract_guid`, `ordinal_number`, `okpd_code`),
